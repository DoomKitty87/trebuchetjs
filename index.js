...
module.exports.simulateWorld = function(world) {
    world.objects.forEach(function(object) {
        ...
        object.force = new THREE.Vector3((Math.max(Math.abs(object.force.x) - world.drag), 0) * Math.sign(object.force.x), (Math.max(Math.abs(object.force.y) - world.drag), 0) * Math.sign(object.force.y), (Math.max(Math.abs(object.force.z) - world.drag), 0) * Math.sign(object.force.z));
